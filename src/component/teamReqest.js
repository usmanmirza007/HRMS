...
export default class teamReqest extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
            ...
            <View style={styles.container}>
                ...
                <ScrollView>
                    <View style = {{flexDirection: 'row',  marginVertical: hp('3%')}}>
                        <Text style = {{fontSize: 15, fontWeight: 'bold', marginLeft: wp('9.5%')}} >Username</Text>
                        <Text style = {{fontSize: 15, fontWeight: 'bold', marginLeft: wp('18%')}}>Travel</Text>
                    </View>
